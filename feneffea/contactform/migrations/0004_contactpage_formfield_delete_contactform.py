...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('contactform', '0003_contactform_contact_image'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='contactform.contactpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
